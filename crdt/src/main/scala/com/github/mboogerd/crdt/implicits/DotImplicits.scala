...
import com.github.mboogerd.crdt.delta.dot.DotInstances.{ DotFunStore, DotMapStore, DotSetStore }
import com.github.mboogerd.crdt.delta.dot.{ DotFun, DotMap, DotSet, DotStore }
